...
image::descriptor_indexing/sample.png[Sample]
...
image:descriptor_indexing/non-uniform-draw.png[non-uniform-draw]
...
image::descriptor_indexing/non-uniform-usage.png[non-uniform-usage]
...
image::descriptor_indexing/update-after-bind.png[update-after-bind]
