...
TIP: The source for this sample can be found in the {github-repo-url}extensions/graphics_pipeline_library[Khronos Vulkan samples github repository].
endif::[]
...
image::graphics_pipeline_library/sample.jpg[Sample]
