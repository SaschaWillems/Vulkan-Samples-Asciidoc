...
image::afbc/afbc_disabled.jpg[Sponza AFBC off]
...
image::afbc/afbc_enabled.jpg[Sponza AFBC on]
...
image::afbc/streamline_disabled.png[Streamline AFBC Off]
image::afbc/streamline_enabled.png[Streamline AFBC On]
