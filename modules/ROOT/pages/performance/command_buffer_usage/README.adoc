...
image::command_buffer_usage/single_threading.png[Single-threaded]

image::command_buffer_usage/multi_threading.png[Multi-threaded]
...
image::command_buffer_usage/allocate_and_free.jpg[Allocate and Free]
...
image::command_buffer_usage/reset_buffers.jpg[Reset Buffers]
...
image::command_buffer_usage/reset_pool.jpg[Reset Pool]
...
image:command_buffer_usage/android_profiler_allocate_and_free.png[Android Profiler: Allocate and Free] _Android Profiler capture: use the Flame Chart to visualize which functions take the most time in the capture.
