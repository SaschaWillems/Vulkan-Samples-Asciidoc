...
image::multithreading_render_passes/render_passes_diagram.png[Render Passes Diagram]
...
image::multithreading_render_passes/no_multi_threading.png[Single Thread]

Using two threads gives a 10ms frame time improvement and CPU cycles show an increase in CPU utilization:

image::multithreading_render_passes/primary_command_buffers.png[Primary Command Buffers]

With secondary command buffers you can see a further drop in frame time.

image::multithreading_render_passes/secondary_command_buffers.png[Secondary Command Buffers]
...
image::multithreading_render_passes/android_studio_capture_no_multithreading.png[Profiler Capture No Multithreading] _Multithreading is disabled_
...
image::multithreading_render_passes/android_studio_capture_secondary_buffers.png[Profiler Capture Secondary Command Buffers] _Multithreading is enabled and the timeline shows how both threads are used_
...
xref:performance/command_buffer_usage/README.adoc[Command buffer usage and multi-threaded recording]
