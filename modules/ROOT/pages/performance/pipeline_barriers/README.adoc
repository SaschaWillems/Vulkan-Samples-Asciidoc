...
image:pipeline_barriers/immediate_mode_rendering.png[Traditional Approach]
...
image:pipeline_barriers/tile_based_rendering.png[Tile-based Approach]
...
image:pipeline_barriers/mali_three_stage_pipeline.png[Mali's three stage pipeline]
...
see xref:performance/subpasses/README.adoc[the subpasses tutorial] for more detail.
...
image:pipeline_barriers/sample_bot_to_top.jpg[Sample - Bottom to Top]
...
image:pipeline_barriers/sample_frag_to_vert.jpg[Sample - Frag to vert]
...
image:pipeline_barriers/sample_frag_to_frag.jpg[Sample - Frag to frag]
