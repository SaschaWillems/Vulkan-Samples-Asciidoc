...
image::render_passes/load_store.jpg[Using LOAD_OP_LOAD]
...
image::render_passes/clear_store.jpg[Using LOAD_OP_CLEAR]
...
The savings will be lower if the images are compressed, see xref:performance/afbc/README.adoc[Enabling AFBC in your Vulkan Application].
...
image::render_passes/clear_dont_care.jpg[Using LOAD_OP_CLEAR and STORE_OP_DONT_CARE]
...
image::render_passes/render_passes_streamline.png[Streamline]
...
image::render_passes/vk_cmd_clear.png[vkCmdClear]
