...
image::specialization_constants/specialization_constants_sample.png[Specialization Constants Samples]
...
image::specialization_constants/UBOs_graph.png[UBOs Graph]
...
image::specialization_constants/specialization_constants_graph.png[Specialization Constants Graph]
