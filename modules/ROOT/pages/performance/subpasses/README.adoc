...
image::subpasses/render-passes.jpg[Render passes]
...
image::subpasses/subpasses-renderpasses-trace.jpg[Subpasses vs render passes trace]
...
image::subpasses/good-practice.jpg[Good practice]
...
image::subpasses/gbuffer-size.jpg[G-buffer size]
...
image::subpasses/transient-attachments.jpg[Non-transient attachments]
...
* Follow the basic xref:performance/render_passes/README.adoc[render pass best practices], with `LOAD_OP_CLEAR` or `LOAD_OP_DONT_CARE` for attachment loads and `STORE_OP_DONT_CARE` for transient stores.
